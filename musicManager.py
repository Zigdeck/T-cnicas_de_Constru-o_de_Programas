...
class MusicManager:
    def __init__(self, texto, instrumento, volume_inicial, volume_atual, bpm, oitava):
        self.texto = texto
        ...
        self.bpm = bpm
        self.oitava = oitava
        self.musica = MusicProperties(instrumento, volume_inicial, volume_atual, bpm, oitava)
